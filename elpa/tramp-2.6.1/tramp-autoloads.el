...
of `current-buffer'." (or (let ((buf (or buffer (current-buffer)))) (when (bufferp buf) (with-current-buffer (or buffer (current-buffer)) (substring-no-properties (buffer-string))))) ""))
