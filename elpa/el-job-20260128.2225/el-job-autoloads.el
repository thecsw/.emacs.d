...
(autoload 'el-job-parallel-mapcar "el-job" "\
...
(fn FN LIST &optional INJECT-VARS)")
(register-definition-prefixes "el-job" '("el-job-internal-version"))
...

;;; Generated autoloads from el-job-ng-debug.el

(autoload 'el-job-ng-debug-kill-all "el-job-ng-debug" "\
Kill all jobs and forget all metadata." t)
(autoload 'el-job-ng-debug-cycle "el-job-ng-debug" "\
Cycle through values for `el-job-ng--debug-level'." t)
